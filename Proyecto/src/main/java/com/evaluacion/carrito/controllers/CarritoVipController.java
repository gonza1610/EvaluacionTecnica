...
import com.evaluacion.carrito.services.CarritoServiceVip;

@CrossOrigin(origins= {"http://localhost:4200/"})
@RestController
@RequestMapping("/api/carritoVip")
public class CarritoVipController {

	@Autowired
	CarritoServiceVip service;
	...
	public ResponseEntity<?> delete(@PathVariable("id") Long id){
		Carrito carrito= service.findById(id);
		 ...
		 response.put("mensaje", "El carrito Vip ha sido elimnado exitosamente");
		 return new ResponseEntity<Map<String, Object>>(response, HttpStatus.OK);
	}
